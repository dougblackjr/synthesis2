class AdmissionsController < ApplicationController
  ...
  private
    ...
    def admission_params
      params.require(:admission).permit(:active, :admissionDate, :admissionStatus, :bed_id, :blackout, :blackoutDate, :closeDate, :closeReason, :locker, :module, :program_id, :referralSource, :referralReason, :resident_id)
    end
end
