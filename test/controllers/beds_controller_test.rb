...
class BedsControllerTest < ActionController::TestCase
  ...
  test "should create bed" do
    assert_difference('Bed.count') do
      post :create, bed: { bedLocation: @bed.bedLocation, bedNotes: @bed.bedNotes, bedNumber: @bed.bedNumber, occupied: @bed.occupied, place_id: @bed.place_id, resident_id: @bed.resident_id }
    end
  ...
  test "should update bed" do
    patch :update, id: @bed, bed: { bedLocation: @bed.bedLocation, bedNotes: @bed.bedNotes, bedNumber: @bed.bedNumber, occupied: @bed.occupied, place_id: @bed.place_id, resident_id: @bed.resident_id }
    assert_redirected_to bed_path(assigns(:bed))
  end
